 ...
 */
class Version20180303194409 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE recipe_user_follow_book ADD CONSTRAINT FK_1854C0DFA76ED395 FOREIGN KEY (user_id) REFERENCES recipe_user (id) ON DELETE CASCADE');
